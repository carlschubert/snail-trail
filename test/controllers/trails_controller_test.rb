...
class TrailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trail" do
    assert_difference('Trail.count') do
      post trails_url, params: { trail: { length: @trail.length, snail_id: @trail.snail_id, vector: @trail.vector } }
    end
  ...
  test "should update trail" do
    patch trail_url(@trail), params: { trail: { length: @trail.length, snail_id: @trail.snail_id, vector: @trail.vector } }
